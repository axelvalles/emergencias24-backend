...
export class Migration1780280595097 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "patients" ADD CONSTRAINT "FK_97d50f26dd5764039a2cbf2c30b" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "patients" DROP CONSTRAINT "FK_97d50f26dd5764039a2cbf2c30b"`,
    );
    await queryRunner.query(
