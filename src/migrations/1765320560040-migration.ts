...
export class Migration1765320560040 implements MigrationInterface {
    name = 'Migration1765320560040'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_roles_enum" AS ENUM('super_admin', 'clinic_admin', 'operator', 'doctor', 'nurse', 'receptionist', 'lab_admin', 'finance')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."patients_document_type_enum" AS ENUM('CC', 'CE', 'PASSPORT', 'NIT', 'OTHER')`);
        await queryRunner.query(`CREATE TYPE "public"."patients_blood_type_enum" AS ENUM('A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-')`);
        await queryRunner.query(`CREATE TYPE "public"."patients_patient_status_enum" AS ENUM('Active', 'Inactive', 'Deceased')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."plan_subscriptions_role_enum" AS ENUM('HOLDER', 'BENEFICIARY', 'MEMBER')`);
        await queryRunner.query(`CREATE TYPE "public"."plan_subscriptions_status_enum" AS ENUM('ACTIVE', 'INACTIVE', 'SUSPENDED', 'CANCELLED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."plan_groups_group_type_enum" AS ENUM('FAMILY', 'CORPORATE')`);
        await queryRunner.query(`CREATE TABLE "plan_groups" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "plan_id" uuid NOT NULL, "group_type" "public"."plan_groups_group_type_enum" NOT NULL, "company_id" uuid, "holder_id" uuid, "entity_name" character varying(255) NOT NULL, "start_date" date NOT NULL, "end_date" date, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), CONSTRAINT "PK_8d3129e9affc5950fd53217990a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."plans_plan_type_enum" AS ENUM('FAMILY', 'GROUP')`);
        await queryRunner.query(`CREATE TYPE "public"."plans_group_category_enum" AS ENUM('EMPRESARIAL', 'COLECTIVO')`);
        ...
        await queryRunner.query(`ALTER TABLE "plan_subscriptions" ADD CONSTRAINT "FK_8e7901df531b6a35f19ff4de500" FOREIGN KEY ("patient_id") REFERENCES "patients"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plan_subscriptions" ADD CONSTRAINT "FK_7e88ddf0c7d81b881453f0c013e" FOREIGN KEY ("plan_group_id") REFERENCES "plan_groups"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plan_groups" ADD CONSTRAINT "FK_e1babae9bfce1abd3856ab65a28" FOREIGN KEY ("plan_id") REFERENCES "plans"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tickets" ADD CONSTRAINT "FK_7c2894ec48d1aeeb9a57680ab12" FOREIGN KEY ("patientId") REFERENCES "patients"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tickets" ADD CONSTRAINT "FK_d1beac6cf7fa5a0742a693c9aa9" FOREIGN KEY ("assignedTo") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "tickets" DROP CONSTRAINT "FK_d1beac6cf7fa5a0742a693c9aa9"`);
        await queryRunner.query(`ALTER TABLE "tickets" DROP CONSTRAINT "FK_7c2894ec48d1aeeb9a57680ab12"`);
        await queryRunner.query(`ALTER TABLE "plan_groups" DROP CONSTRAINT "FK_e1babae9bfce1abd3856ab65a28"`);
        await queryRunner.query(`ALTER TABLE "plan_subscriptions" DROP CONSTRAINT "FK_7e88ddf0c7d81b881453f0c013e"`);
        await queryRunner.query(`ALTER TABLE "plan_subscriptions" DROP CONSTRAINT "FK_8e7901df531b6a35f19ff4de500"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."plans_group_category_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."plan_subscriptions_role_enum"`);
        await queryRunner.query(`DROP TABLE "patients"`);
        await queryRunner.query(`DROP TYPE "public"."patients_patient_status_enum"`);
        await queryRunner.query(`DROP TYPE "public"."patients_blood_type_enum"`);
        await queryRunner.query(`DROP TYPE "public"."patients_document_type_enum"`);
