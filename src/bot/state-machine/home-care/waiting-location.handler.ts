  ...
  async handle(
    ...
    await services.ticketsService.create({
      ...
      description: location
        ? `Solicitud de atención domiciliaria, municipio: ${_context.municipality} en coordenadas (${location.latitude}, ${location.longitude})`
        : `Solicitud de atención domiciliaria, municipio: ${_context.municipality} en la ubicación: ${body.trim()}`,
    });
