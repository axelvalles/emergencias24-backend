...
import { MedicalConsultationsConfirmationHandler } from './medical-consultations/waiting-confirmation.handler';
...
export const stateMachine: Record<BotStates, StateHandler> = {
  ...
  MEDICAL_CONSULTATIONS_CONFIRMATION:
    new MedicalConsultationsConfirmationHandler(),
